...
//        jika di klik salah satu prodi tampilkan activity detail prodi
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View container,
                ...
                if (position == 0) {
                    Intent myIntent = new Intent(container.getContext(), AdmPajak.class);
                    startActivityForResult(myIntent, 0);
                }

                if (position == 1) {
                    Intent myIntent = new Intent(container.getContext(), ManInf.class);
                    startActivityForResult(myIntent, 0);
                }
                if (position == 2) {
                    Intent myIntent = new Intent(container.getContext(), Pariwisata.class);
                    startActivityForResult(myIntent, 0);
                }
                if (position == 3) {
                    Intent myIntent = new Intent(container.getContext(), AgriPangan.class);
                    startActivityForResult(myIntent, 0);
                }
                if (position == 4) {
                ...
                if (position == 6) {
                    Intent myIntent = new Intent(container.getContext(), Hotel.class);
                    startActivityForResult(myIntent, 0);
                }
            }
        };
