...
public class Tektan extends AppCompatActivity {
...
//        jika di klik salah satu prodi tampilkan activity detail prodi
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View container,
                ...
                if (position == 0) {
                    Intent myIntent = new Intent(container.getContext(), Patiseri.class);
                    startActivityForResult(myIntent, 0);
                }

                if (position == 1) {
                    Intent myIntent = new Intent(container.getContext(), TSL_Lingkungan.class);
                    startActivityForResult(myIntent, 0);
                }
                if (position == 2) {
                ...
                if (position == 5) {
                    Intent myIntent = new Intent(container.getContext(), TRJJ.class);
                    startActivityForResult(myIntent, 0);
                }
                if (position == 6) {
